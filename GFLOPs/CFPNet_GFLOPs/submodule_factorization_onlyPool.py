...
class feature_extraction(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('out1_1:',out1_1.shape)
        #print('out1_2:',out2_1.shape)
        #print('inPooling:',inPooling.shape)
        #print('out_fusion1:',out_fusion1.shape)
        output_feature = torch.cat((out1_1, out1_2, inPooling, output_branch1, output_branch2, output_branch3, output_branch4), 1)
